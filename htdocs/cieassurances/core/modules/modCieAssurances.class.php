...
/**
 *  Description and activation class for module CieAssurances
 */
class modCieAssurances extends DolibarrModules
{
    /**
    ...
    function __construct($db)
    {
        ...
        // Dictionnaries
        if (! isset($conf->cieassurances->enabled))
        {
            $conf->cieassurances=new stdClass();
            $conf->cieassurances->enabled=0;
        }
    ...
    function remove($options='')
    {
        require_once DOL_DOCUMENT_ROOT.'/societe/class/thirdpartiestypes.class.php';
        $customtypes = new ThirdPartiesTypes($this->db);
        $customtypes->delete('cieassurances');
        $sql = array();
